...
// --- 2. Dynamic Component Render (Cards) ---
function renderSamples(data) {
    ...
    data.forEach(s => {
        ...
        let claimsHtml = '';
        const entries = Object.entries(s.claims);
        ...
        const footerLabel = s.claims['Taxonomic Rank'] || s.claims['Tissue'] || s.claims['Species'] || 'Genomic Record';
        ...
        card.innerHTML = `
            ...
            <div class="relative z-10 flex flex-col h-full">
                <div class="flex justify-between items-start mb-6">
                    ...
                    <a href="${s.url}" target="_blank" onclick="event.stopPropagation()" title="View on Wikibase" class="text-slate-500 hover:text-cyan-400 transition-colors bg-white/[0.03] p-2.5 rounded-full hover:bg-white/10 border border-transparent hover:border-white/10">
